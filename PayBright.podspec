#
#  Be sure to run `pod spec lint PayBright.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://paybright.com/"
  ...
  spec.author             = "PayBright"
  
  # Or just: spec.author    = ""
  # spec.authors            = { "" => "" }
  
  spec.social_media_url   = "https://twitter.com/PayBrightCanada"
  ...
  #  spec.source_files  = "PayBright/Source/*.{swift}"
